...
function Terminos() {
  return (
    <div>Términos y Condiciones de Uso
    ...
    El usuario puede elegir y cambiar la clave para su acceso de administración de la cuenta en cualquier momento, en caso de que se haya registrado y que sea necesario para la compra de alguno de nuestros productos. bestbet.es no asume la responsabilidad en caso de que entregue dicha clave a terceros.
    ...
    Este bestbet.es garantiza que la celta de vigo noticias información personal que usted envía cuenta con la seguridad necesaria. Los datos ingresados por usuario o en el caso de requerir una validación de los pedidos no serán entregados a terceros, salvo que deba ser revelada en cumplimiento a una orden judicial o requerimientos legales.
    
    La suscripción a boletines de correos electrónicos publicitarios es voluntaria y podría ser seleccionada al momento de crear su cuenta.
    
    BestBet reserva los derechos de cambiar o de modificar estos términos sin previo aviso.</div>
  )
}
